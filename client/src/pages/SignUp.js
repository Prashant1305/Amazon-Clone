                    ...
                    <div className='sign_form'>
                        <form onSubmit={handlesubmit}>
                            ...
                            <div className='form_data'>
                                ...
                                <input type='text' name="username" id="username" placeholder='Atleast 3 chracters ' onChange={(e) => { handleChange(e) }} value={userData.username} />
                            </div>
                            <div className='form_data'>
                                <label htmlFor='Email'>Email</label>
                                <input type='email' name="email" id="email" placeholder='abc@domain.com' onChange={(e) => { handleChange(e) }} value={userData.email} />
                            </div>
                            <div className='form_data'>
                                <label htmlFor='Phone'>Phone</label>
                                <input type='text' name="phone" id="phone" onChange={(e) => { handleChange(e) }} value={userData.phone} />
                            </div>
                            <div className='form_data'>
